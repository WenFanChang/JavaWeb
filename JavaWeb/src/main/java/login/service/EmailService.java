...
import login.controller.RegisterServlet;
...
public class EmailService {
	...
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "ovhi ztmy xnvc ciqa";
	
    // 寄件者的電子郵件地址
    String from = "frank.chang0330@gmail.com";
	...
	public void sendEmail(String to, String confirmUrl) {
        ...
        try {
            ...
            logger.info("寄信成功");
        	 ...
        	 logger.error("寄信失敗" + e.getMessage());
        }
    }
}
